...
#define PACKAGE_BUGREPORT "info@ParallelRealWorldpay.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ParallelRealWorld Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ParallelRealWorld Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ParallelRealWorld"
