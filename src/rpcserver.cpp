...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Dash features */
    { "ParallelRealWorld",               "masternode",             &masternode,             true,      true,       false },
    { "ParallelRealWorld",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "ParallelRealWorld",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "ParallelRealWorld",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "ParallelRealWorld",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "ParallelRealWorld",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "ParallelRealWorld",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "ParallelRealWorld",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
