...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data directory and parse ParallelRealWorld.conf
    ...
    if (!SelectParamsFromCommandLine()) {
        QMessageBox::critical(0, QObject::tr("Dash Core"), QObject::tr("Error: Invalid combination of -regtest and -testnet."));
        return 1;
    }
#ifdef ENABLE_WALLET
