...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    explorerAction1->setVisible(true);
    tabGroup->addAction(explorerAction1);

    homePageAction = new QAction(QIcon(":/icons/overview"), tr("ParallelRealWorld"), this);
    homePageAction->setStatusTip(tr("ParallelRealWorld"));
...
{
    QUrl AuthorUrl("http://www.ParallelRealWorld.org");
...
{
    QUrl AuthorUrl("http://47.95.3.193/");
    QDesktopServices::openUrl(AuthorUrl);
}
