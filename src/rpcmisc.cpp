...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"ParallelRealWorldAddress\"\n"
            "\nReturn information about the given ParallelRealWorld Address.\n"
            "\nArguments:\n"
            "1. \"ParallelRealWorldAddress\"     (string, required) The ParallelRealWorld address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"ParallelRealWorldAddress\", (string) The ParallelRealWorld address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: ParallelRealWorld Address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are ParallelRealWorld Addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) ParallelRealWorld Address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"ParallelRealWorldAddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"ParallelRealWorldAddress\"  (string, required) The ParallelRealWorld Address to use for the signature.\n"
