...
int64_t GetBlockValue(int nBits, int nPrevHeight, const CAmount& nFees)
{
    ...
    if(nPrevHeight == 1){
        ...
        nSubsidy = 4 * COIN;
    }else if(nPrevHeight < one_year * 16){
        nSubsidy = 4 * COIN;
    }else if(nPrevHeight < one_year * 15){
        nSubsidy = 4 * COIN;
    }
...
int64_t GetMasternodePayment(int nPrevHeight, int64_t blockValue)
{
    //(1440*0*1+1)~1440*30*1		60		10	30
    //(1440*30*1+1)~1440*30*2		57.5	10	32.5
    //(1440*30*2+1)~1440*30*3		55		10	35
    //(1440*30*3+1)~1440*30*4		52.5	10	37.5
    //(1440*30*4+1)~1440*30*5		50		10	40
    //(1440*30*5+1)~1440*30*6		47.5	10	42.5
    //(1440*30*6+1)~1440*30*7		45		10	45
    //(1440*30*7+1)~1440*30*8		42.5	10	47.5
    //(1440*30*8+1)~1440*30*9		40		10	50
    //(1440*30*9+1)~1440*30*10      37.5	10	52.5
    //(1440*30*10+1)~1440*30*11     35		10	55
    //(1440*30*11+1)~1440*30*12     32.5	10	57.5

    //(1440*30*12+1)~1440*30*24     30      10	60

    //(1440*30*24+1)~               30      5	65
    if(nPrevHeight <=10){
        return 0;
    }else if(nPrevHeight < 1440*30*1){
        return blockValue * 0.30;
    }else if(nPrevHeight < 1440*30*2){
        return blockValue * 0.325;
    }else if(nPrevHeight < 1440*30*3){
        return blockValue * 0.35;
    }else if(nPrevHeight < 1440*30*4){
        return blockValue * 0.375;
    }else if(nPrevHeight < 1440*30*5){
        return blockValue * 0.40;
    }else if(nPrevHeight < 1440*30*6){
        return blockValue * 0.425;
    }else if(nPrevHeight < 1440*30*7){
        return blockValue * 0.45;
    }else if(nPrevHeight < 1440*30*8){
        return blockValue * 0.475;
    }else if(nPrevHeight < 1440*30*9){
        return blockValue * 0.50;
    }else if(nPrevHeight < 1440*30*10){
        return blockValue * 0.525;
    }else if(nPrevHeight < 1440*30*11){
        return blockValue * 0.55;
    }else if(nPrevHeight < 1440*30*12){
        return blockValue * 0.575;
    }else if(nPrevHeight < 1440*30*12*2){
...
bool ConnectBlock(const CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    if(height < 30000){
        ...
        if( block.nVersion == (CBlockHeader::CURRENT_VERSION-1)){
            return state.DoS(0, error("CheckBlock() : wallet version is old"), REJECT_INVALID, "bad-blk-version");
        }
    }
    ...
    int64_t temp = GetBlockValue(pindex->pprev->nBits, pindex->pprev->nHeight, nFees);
    if(pindex->pprev->nHeight == 1){
        temp = 19500000 * COIN;
    }


    if(!IsBlockValueValid(block, temp)){
